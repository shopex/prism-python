...
def _parse_url(url):
    ...
    return (hostname, port, resource, is_secure, rest)
...
class WebSocket(object):
    ...
    def connect(self, url, **options):
        ...
        """
        hostname, port, resource, is_secure, rest = _parse_url(url)
        # TODO: we need to support proxy
        self.sock.connect((hostname, port))
        if is_secure:
            self.io_sock = _SSLSocketWrapper(self.sock)
        self._handshake(hostname, port, rest, **options)
    ...
    def _handshake(self, host, port, resource, **options):
        ...
        headers.append("Sec-WebSocket-Protocol: char")
